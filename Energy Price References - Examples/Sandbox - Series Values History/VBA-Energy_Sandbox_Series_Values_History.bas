Public Function EP_sb_series_values(accessToken As String) As String
    ...
    'Codes you want to get the prices for (separated by commas). If you do not know the codes you have access to, run the Intratec Energy Price References - Sandbox - Series Info API

    'You can also specify the currency and unit, following the available currency and unit for that assessment, according to Intratec Energy Price References - Sandbox - Series Info API
